package com.ardakazanci.anlikmotivasyon
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.ardakazanci.anlikmotivasyon.R.layout.activity_main)


        parentLayout = findViewById(com.ardakazanci.anlikmotivasyon.R.id.activity_main)
    ...
    private fun snackbarShow(view: View) {
        Snackbar.make(
            view,
            getString(com.ardakazanci.anlikmotivasyon.R.string.network_connection_error),
